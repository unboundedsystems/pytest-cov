...
class CovController(object):
    ...
    def __init__(self, cov_source, cov_report, cov_config, cov_append, cov_data, config=None, nodeid=None):
    ...
    def set_env(self):
        ...
        os.environ['COV_CORE_DATAFILE'] = os.path.abspath(self.cov_data)
